...
//$con=mysqli_connect('localhost','root','Sdr@7675','educourse');
if(isset($_POST['dzEmail']) && isset($_POST['dzPass']))
{
...
<head>
	...
	<!-- DESCRIPTION -->
	<meta name="description" content=" EduCourse " />
	
	<!-- OG -->
	<meta property="og:title" content=" EduCourse " />
	<meta property="og:description" content=" EduCourse " />
				...
				<div class="row d-flex justify-content-between">
					<div class="topbar-left">
						<ul>
							...
							<li><a href="javascript:;"><i class="fa fa-envelope-o"></i>services.drj@gmail.com</a></li>
						</ul>
					</div>
						...
						data-description="Science says that Women are generally happier">
							...
							<div class="tp-caption Newspaper-Subtitle   tp-resizeme" 
								...
								style="z-index: 7; text-transform:capitalize; white-space: unset; color:#fff; font-family:rubik; font-size:18px; line-height:28px; font-weight:400;">
									 EduCourse is a education platform that helps students or jobseekers to get job in product and service based company.
							</div>
							<!-- LAYER NR. 4 -->
						...
						<div class="col-lg-4 col-md-4 col-sm-6">
							<div class="service-bx">
								...
								<div class="info-bx text-center">
									...
									<h4><a href="courses.html">Learn Courses Online</a></h4>
						...
						<div class="col-lg-4 col-md-4 col-sm-12">
							<div class="service-bx m-b0">
								...
								<div class="info-bx text-center">
									...
									<h4><a href="#">Best Instructor Profile </a></h4>
									<a href="#" class="btn radius-xl">View More</a>
								</div>
							</div>
						</div>
